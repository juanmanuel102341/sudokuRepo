	...
	public void calc(){
		for(int i=0;i<9;i++){
			for(int i2=0;i2<9;i2++){
				...
				filas[i,i2].GetComponent<Celda>().setObjAux=GameObject.Find("SquareAux");
				filas[i,i2].GetComponent<Celda>().setObjInput=GameObject.Find("SquareInput");
				filas[i,i2].GetComponent<Celda>().Events();
			}
		}
	}
